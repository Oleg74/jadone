              ...
              var  message =
               ...
               var messageBegin1=
                   '<html>'+
                       ...
                       '<h3>Здравствуйте</h3>'+
                       '<p>Поступил следующий заказ с сайта <a href="http://jadone.biz">JADONE.BIZ:</a></p>'+
               ...
               var messageBegin2=
                   '<html>'+
                       '<body bgcolor="#D4D4D4" topmargin="25">'+
                       '<h3>Здравствуйте!</h3>'+
                       '<p>С Вашего адреса на <a href="http://jadone.biz">сайте jadone.biz</a> оформлен следующий заказ:</p>'+
                       '<p>Номер заказа: '+upsertData.num+'</p>'+
                       'Дата : '+moment(upsertData.date).format('LLL')+'<br>';
